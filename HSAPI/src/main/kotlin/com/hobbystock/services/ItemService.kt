...
class ItemService(
  ...
  fun findById(id: Int): Item? = itemRepository.findById(id.toLong()).orElse(null)?.toGraphQLType()
  ...
  fun deleteItem(id: Int): ItemMutationResult {
    return try {
      ...
      ItemMutationResult(success = true, message = "Item deleted successfully", item = null)
    } catch (e: Exception) {
